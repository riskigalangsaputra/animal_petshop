                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" >
                                <thead>
                                    <tr>
                                        ...
                                        <?php
                                	$sql = "select * from barang WHERE jenis_barang = 'makanan' AND kategori = 'makanan'"; 
                                	...
                                	while ($data = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
                                		...
                                		<a href="deletemakanan.php?delete=<?php echo $data ['id_barang'];?>" class="btn btn-md btn-danger"> Hapus</a>
                                		</td>
                                		</tr>
                                		<?php
