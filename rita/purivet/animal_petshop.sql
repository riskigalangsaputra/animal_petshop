...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2019 at 07:09 AM
...
(1, 'admin', 'adminanimalpetshop@gmail.com', '1234');
...
(1, 'Wishkas Junior 85 Gram', 'makanan2.png', 'makanan', 'makanan', 31, 35000, 'Makanan kucing kesayangan, Tuna flavour'),
(2, 'Kandang Kucing Hamster Hewan 3', 'kandang hamster.png', 'aksesoris', 'kandang dan tas', 9, 1250000, 'Kandang Kucing Hamster Hewan 3 Lantai + Bak Plastik C-226'),
(6, 'tempat tidur anjing', 'tempat tidur.png', 'aksesoris', 'tempat tidur', 6, 300000, 'Tempat Tidur Anjing Kedatangan Baru Cama Para Cachorro Rumah Anjing Lembut Harian Produk untuk Hewan Peliharaan Kucing Anjing Rumah Bentuk 1 Warna Merah-Intl'),
...
(37, 'SISIR GROOMING Anjing, Kucing Dan Kelinci Dua Sisi', 'sisir.JPG', 'grooming', 'grooming', 9, 25000, 'SIsir Grooming untuk Anjing, Kucing, Kelinci Dll dengan bentuk dua sisi dengan kerenggangan sisir yang berbeda yang dapat dengan mudah menata bulu hewan kesayangan anda'),
...
(45, 'Mainan gigitan Anjing dan kucing Tali Dog Cat Toy Rope', 'maianantali.JPG', 'aksesoris', 'mainan', 17, 25000, 'Mainan anjing kucing high quality dog toy rope dibuat dari kualitas bahan terbaik beraneka macam warna menarik. membuat anjing anda tidak bosan dan tidak gigit sembarangan. Panjang +-25cm'),
...
(8, 'diky', 'diky@diky.com', '085326657721', 'jl mawar,tanggerang ', 'diky'),
