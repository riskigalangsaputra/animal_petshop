 ...
 ?>	
	...
	<section>
 	...
 	<?php
		...
		$sql = "select * from barang WHERE jenis_barang = 'grooming' AND kategori = 'grooming'";
						...
						<div class="col-sm-4">
							...
							<img width="20" height="300" src= "../admin/pages/gambar/<?php
								...
								<div class="choose">
									...
									<li class="ctr"><form method="GET"><a href="add_cartgrom.php?id=<?php echo $data['id_barang']; ?>"> 
