...
<section>
	...
	<section>
		<div class="container">
				<div class="col-sm-9 padding-center">
					<div class="makanan"><!--makanan-->
						<h2 class="title text-center">Mainan</h2>
		...
		$sql = "select *from barang WHERE jenis_barang = 'aksesoris' AND kategori='mainan'";
						...
						<div class="col-sm-4">
							...
							<img width="20" height="300" src= "../admin/pages/gambar/<?php
								...
								<div class="choose">
									...
									<li class="ctr"><form method="GET"><a href="add_cartmain.php?id=<?php echo $data['id_barang']; ?>"> 
