...
<section>
	...
	<section>
		<div class="container">
				<div class="col-sm-9 padding-center">
					<div class="makanan"><!--makanan-->
						<h2 class="title text-center">Perlengkapan Makan</h2>
		...
		$sql = "select *from barang WHERE jenis_barang = 'aksesoris' AND kategori='perlengkapan makanan'";
						...
						<div class="col-sm-4">
							...
							<img width="20" height="300" src= "../admin/pages/gambar/<?php
								...
								<div class="choose">
									...
									<li class="ctr"><form method="GET"><a href="add_cartpmkn.php?id=<?php echo $data['id_barang']; ?>"> 
